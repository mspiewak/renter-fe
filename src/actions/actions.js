...
export function getBillsPerTenant(id) {
  return dispatch => {
    axios
      .get(
        "http://ec2-3-14-68-218.us-east-2.compute.amazonaws.com:8090/tenant/" +
          id +
          "/bill"
      )
      .then(res => {
...
export function postBill(data) {
  return dispatch => {
    axios
      .post(
        "http://ec2-3-14-68-218.us-east-2.compute.amazonaws.com:8090/bill",
        data
      )
      .then(res => {
        if (res.status === 200) {
...
export function getIncome() {
  return dispatch => {
    axios
      .get(
        "http://ec2-3-14-68-218.us-east-2.compute.amazonaws.com:8090/stats/income"
      )
      .then(res => {
        if (res.status === 200) {
